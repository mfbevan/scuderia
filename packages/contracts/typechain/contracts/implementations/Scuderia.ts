...
export interface ScuderiaInterface extends utils.Interface {
  functions: {
    ...
    "walletOf(address)": FunctionFragment;
...
export interface Scuderia extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ScuderiaInterface;
  ...
  functions: {
    ...
    walletOf(
      _walletOwner: PromiseOrValue<string>,
      overrides?: CallOverrides
  ...
  stakes(
    ...
    [BigNumber, BigNumber] & { timeStaked: BigNumber; lockinPeriod: BigNumber }
  >;
